...
function(a, b) {
    ...
    f = {
        ...
        textAlign: "center",
        verticalMiddle: !0,
        backgroundColor: "rgba(255,201,0,.9)",
        reverse: !1,
        height: "100%",
        withLink: !0
    };
    g.prototype = {
        init: function() {
            ...
            a(this.element).off("mouseenter.sliphover", c).on("mouseenter.sliphover", c,
            function(c) {
                var d = a(c.target),
                e = b.createContainer(d);
                e.off("mouseenter.sliphover mouseleave.sliphover").on("mouseenter.sliphover mouseleave.sliphover",
                function(c) {
                    var f = b.getDirection(a(this), c);
                    if (f = b.settings.reverse ? f = (f + 2) % 4 : f, "mouseenter" === c.type) {
                        var g = e.find(".sliphover-overlay");
                        g.length || (g = b.createOverlay(b, f, d), a(this).html(g)),
                        b.slideIn(b, g)
        ...
        removeOverlay: function(a, c, d) {
            ...
            f.stop().animate(e, a.settings.duration,
            function() {
                c.remove()
            })
        },
